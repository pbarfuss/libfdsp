...
FDSP_EXPORT float scalarproduct_float_c(float *v1, float *v2, uint32_t len);
...
FDSP_EXPORT float scalarproduct_float_sse(float *v1, float *v2, uint32_t len);
...
FDSP_EXPORT float scalarproduct_float_neon(float *v1, float *v2, uint32_t len);
...
FDSP_EXPORT void aac_update_ltp_sse(float *dst, const float *buf, const float *win, unsigned int len);
FDSP_EXPORT void vorbis_inverse_coupling_sse(float *mag, float *ang, unsigned int blocksize);
FDSP_EXPORT void calc_power_spectrum_sse(float *psd, const FFTComplex *vin, unsigned int len);

FDSP_EXPORT void aacenc_calc_expspec_neon(float *expspec, float *mdct_spectrum, unsigned int len);
FDSP_EXPORT void aac_update_ltp_neon(float *dst, const float *buf, const float *win, unsigned int len);
FDSP_EXPORT void vorbis_inverse_coupling_neon(float *mag, float *ang, unsigned int blocksize);
FDSP_EXPORT void calc_power_spectrum_neon(float *psd, const FFTComplex *vin, unsigned int len);
...
FDSP_EXPORT void sbr_autocorrelate_c(const FFTComplex x[40], float acorr_sums[5], unsigned int ac_len);
FDSP_EXPORT void sbr_hf_g_filt_c(FFTComplex *Y, FFTComplex (*X_high)[40], const float *g_filt, size_t m_max, size_t ixh);
...
FDSP_EXPORT void sbr_qmf_post_shuffle_sse(FFTComplex W[32], float *__restrict z);
FDSP_EXPORT void sbr_qmf_post_shuffle_avx(FFTComplex W[32], float *__restrict z);
FDSP_EXPORT void sbr_autocorrelate_sse(const FFTComplex x[40], float acorr_sums[5], unsigned int ac_len);
FDSP_EXPORT void sbr_hf_g_filt_sse(FFTComplex *Y, FFTComplex (*X_high)[40], const float *g_filt, size_t m_max, size_t ixh);
...
FDSP_EXPORT void sbrenc_qmf_deint_bfly_sse(float *__restrict v, const float *__restrict src0, const float *__restrict src1);
FDSP_EXPORT void sbr_qmf_synthesis_window_sse(float *__restrict out, float *__restrict v, float *__restrict sbr_qmf_window);
FDSP_EXPORT void sbr_qmf_synthesis_window_ds_sse(float *__restrict out, float *__restrict v, float *__restrict sbr_qmf_window);
...
FDSP_EXPORT void sbr_autocorrelate_neon(const FFTComplex x[40], float acorr_sums[5], unsigned int ac_len);
FDSP_EXPORT void sbr_hf_g_filt_neon(FFTComplex *Y, FFTComplex (*X_high)[40], const float *g_filt, size_t m_max, size_t ixh);
...
FDSP_EXPORT void sbrenc_qmf_deint_bfly_neon(float *__restrict v, const float *__restrict src0, const float *__restrict src1);
FDSP_EXPORT void sbr_qmf_synthesis_window_neon(float *__restrict out, float *__restrict v, float *__restrict sbr_qmf_window);
FDSP_EXPORT void sbr_qmf_synthesis_window_ds_neon(float *__restrict out, float *__restrict v, float *__restrict sbr_qmf_window);
